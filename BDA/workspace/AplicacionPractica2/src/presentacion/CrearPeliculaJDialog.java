...
public class CrearPeliculaJDialog extends JDialog {
	...
	public CrearPeliculaJDialog(Controlador c) {
		...
		{
			JLabel lblDireccion = new JLabel("T\u00EDtulo:");
		...
		{
			JLabel lblFecha = new JLabel("Duraci\u00F3n:");
		...
		{
			JLabel lblAsesor = new JLabel("Libro:");
	...
	private void crearPeliculaMenuItemActionPerformed(ActionEvent arg0){
		...
		if (textFieldCodigo.getText().isEmpty()){
			JOptionPane.showMessageDialog(this, "Se debe introducir el código.", "Error", JOptionPane.ERROR_MESSAGE);
			textFieldCodigo.grabFocus();
			return;
		}
		if (textFieldTitulo.getText().isEmpty()){
			JOptionPane.showMessageDialog(this, "Se debe introducir el título.", "Error", JOptionPane.ERROR_MESSAGE);
			textFieldTitulo.grabFocus();
			return;
		}
		if (textFieldDuracion.getText().isEmpty()){
			JOptionPane.showMessageDialog(this, "Se debe introducir la duración.", "Error", JOptionPane.ERROR_MESSAGE);
			textFieldTitulo.grabFocus();
			return;
		}
		int duracion=0;
		try{
			...
			if (duracion<=0){
				JOptionPane.showMessageDialog(this, "La duración debe ser mayor que 0.", "Error", JOptionPane.ERROR_MESSAGE);
		...
		try{
			...
			JOptionPane.showMessageDialog(this,"Pelicula creada correctamente.", "Película",JOptionPane.INFORMATION_MESSAGE);
