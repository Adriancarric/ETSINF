...
//	}
	...
	public MostrarPeliculas(Controlador control) throws Exception {
		setTitle("Listado de Pel\u00EDculas con sus actores");
...
//		});
		...
		lblNewLabel = new JLabel("Actores que act\u00FAan en la pel\u00EDcula seleccionada");
		...
		contentPanel.add(lblNewLabel);
		{
			...
			{
				JButton okButton = new JButton("Mostrar ruta");
	...
	//******************************************************************************************
	    class PeliculaTableModel extends AbstractTableModel {
			...
			private String[] columnNames = { "CodPeli", "Título","Año", "Duración", "Director", "Basada en", "Autor libro"};
	  ...
	  //******************************************************************************************
		...
		//******************************************************************************************
		    class ActorTableModel extends AbstractTableModel {
				...
				private String[] columnNames = { "CodAct", "Nombre", "Fecha nacimiento", "Nombre pais"};
