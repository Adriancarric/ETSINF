...
public class CineApp {
	...
	private void initialize() {
		...
		frmGestionCine.setTitle("Gesti\u00F3n Cine");
		...
		mntmCrearPelicula = new JMenuItem("Crear Pel\u00EDcula");
		...
		mntmAnyadirActuacion = new JMenuItem("A\u00F1adir Actuaci\u00F3n");
		...
		mntmListarPeliculas = new JMenuItem("Listar Pel\u00EDculas");
