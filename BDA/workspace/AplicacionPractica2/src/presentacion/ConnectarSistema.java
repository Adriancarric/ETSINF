...
public class ConnectarSistema extends JDialog {
	...
	public ConnectarSistema(Controlador c) {
		...
		setResizable(false);
		controlador=c;
		setTitle("Connectarse al sistema");
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						...
						try{
							...
							{
								JOptionPane.showMessageDialog(dialogo,"Debe rellenar todos los campos.", "ERROR", JOptionPane.ERROR_MESSAGE);
							}
							else
							{
							controlador.connectarDAL(textFieldLogin.getText(),	contraseña);
							  JOptionPane.showMessageDialog(dialogo,"Conectado correctamente.", "Conexión",JOptionPane.INFORMATION_MESSAGE);
