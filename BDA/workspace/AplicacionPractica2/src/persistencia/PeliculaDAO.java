...
public class PeliculaDAO {
	...
	public PeliculaDTO buscarPeliculaPorCod(String cod)	throws DAOExcepcion{
		try{
			String query = "select * from pelicula where cod_peli = '"+cod+"'";
	...
	public void crearPelicula(PeliculaDTO peli) throws DAOExcepcion {
		try{
			String query = "INSERT INTO PELICULA VALUES ("+peli.toStringCod_peli()+"," 
					+peli.toStringTitulo()+","+peli.toStringAnyo()+","+peli.toStringDuracion()
					+","+peli.toStringCod_lib()+","+peli.toStringDirector()+")";
