...
#define FIRST_FP_XX_S 135 /* FIRST C_XX_S */
...
#define LAST_FP_XX_S 140 /* LAST C_XX_S */
...
#define FIRST_FP_XX_D 148 /* FIRST C_XX_D */
...
#define LAST_FP_XX_D 153 /* LAST C_XX_D */
...
#define inst_fpsr(i) (((i) >= FIRST_FP_XX_S && (i) <= LAST_FP_XX_S) || ((i) >= FIRST_FP_XX_D && (i) <= LAST_FP_XX_D))
