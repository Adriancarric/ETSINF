...
#define imprime_R_int(resultado, mnemonic, instruccion) { \
...
#define imprime_I_int(resultado, mnemonic, instruccion) { \
sprintf(resultado, "%s r%d,r%d,#%d", mnemonic, \
            instruccion.Rdestino, \
            instruccion.Rfuente1, \
...
#define imprime_L_int(resultado, mnemonic, instruccion) { \
...
#define imprime_L_fp(resultado, mnemonic, instruccion) { \
...
#define imprime_S_int(resultado, mnemonic, instruccion) { \
sprintf(resultado, "%s r%d,%s(r%d)", mnemonic, \
        instruccion.Rfuente2, \
        instruccion.etiqueta, \
        instruccion.Rfuente1 \
...
#define imprime_S_fp(resultado, mnemonic, instruccion) { \
sprintf(resultado, "%s f%d,%s(r%d)", mnemonic, \
        instruccion.Rfuente2, \
        instruccion.etiqueta, \
        instruccion.Rfuente1 \
...
#define imprime_CMP_fp(resultado, mnemonic, instruccion) { \
...
#define imprime_R_fp(resultado, mnemonic, instruccion) { \
...
#define imprime_B(resultado, mnemonic, instruccion) { \
te_etiqueta(aux, PC + 4 + instruccion.inmediato, m_instruc); \
sprintf(resultado, "%s %s", mnemonic, \
        aux); \
}

#define imprime_Bx(resultado, mnemonic, instruccion) { \
te_etiqueta(aux, PC + 4 + instruccion.inmediato, m_instruc); \
...
#define imprime_Bxx(resultado, mnemonic, instruccion) { \
te_etiqueta(aux, PC + 4 + instruccion.inmediato, m_instruc); \
