...
public class GrafoMunicipios {
    ...
    public GrafoMunicipios() {
        ...
        ver2Muni = /*COMPLETAR*/ new TablaHash<Integer, Municipio> (NUM_MAX_MUNICIPIOS);
        muni2Ver = /*COMPLETAR*/ new TablaHash<Municipio, Integer> (NUM_MAX_MUNICIPIOS);
        try {         
    ...
    public int obtenerCodigo(Municipio m) {
        //COMPLETAR       
        Integer codigo = muni2Ver.recuperar(m);
        if(codigo == null) {
            return -1;
        }
    ...
    public Municipio getMunicipio(int indice) { 
        //COMPLETAR
        Municipio m = ver2Muni.recuperar(indice);
    ...
    public double distancia(Municipio m1, Municipio m2) {
        return grafo.pesoArista(/*COMPLETAR*/obtenerCodigo(m1), obtenerCodigo(m2) /*COMPLETAR*/);
    }
    ...
    public ListaConPI<Municipio> caminoMinimo(Municipio mOrig, Municipio mDst) {    
        ...
        for(lista.inicio() ; !lista.esFin(); lista.siguiente()) {
            camino.insertar(getMunicipio(lista.recuperar()));
        }
