...
public class Recomendacion{
    ...
    protected int noPags = 0;   
    //COMPLETAR: Declarar como atributo protected la Cola de Prioridad (qp) de Referencia   sWeb
    ...
    public ReferenciasWeb[] maxKReferencias(int k) {
        //COMPLETAR
        ReferenciasWeb kref[] = new ReferenciasWeb[k];
        for(int i=0; i<k; i++) {
            kref[i] = qp.eliminarMin();
        }
        return kref;
