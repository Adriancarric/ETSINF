...
public class Test3Map {
    ...
    public static void main(String[] args) {
        ...
        librerias.estructurasDeDatos.modelos.Map<String, Integer> m = new TablaHash<String, Integer>(palabrasTexto.length);
        ...
        for (int i = 0; i < palabrasTexto.length; i++) { 
            ...
            // luego no puedes preguntar si frec!=null ... Y si preguntas si
            // frec!=1, por ejemplo, la JVM lanza NullPointerException al 
            // ejecutar m.recuperar(palabra)
