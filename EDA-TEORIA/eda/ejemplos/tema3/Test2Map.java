 ...
 *  teclado y muestra por pantalla un listado en el que en cada linea 
 *  contiene una palabra distinta del texto leido junto con su 
 *  frecuencia de aparicion (o numero de veces que se repite) en el 
 */
...
public class Test2Map {
    ...
    public static void main(String[] args) {
        ...
        librerias.estructurasDeDatos.modelos.Map<String, String> m = new TablaHash<String, String>(texto.length());
